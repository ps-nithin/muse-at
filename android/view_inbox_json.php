...
<div class="header_div">
    <div class="menu_item first_menu_item"><a href="welcome.php">&lt;</a></div>
    <div class="menu_item"><?php echo "@".$_GET['id'];?></div>
</div>
</div>
...
if(strcmp(trim($museid),"unknown")!=0 and $del_flag['delete_flag']==0){
echo "
  ...
  <input type='text' class='input_text_inbox' name='send_content' placeholder='type here...'/>
